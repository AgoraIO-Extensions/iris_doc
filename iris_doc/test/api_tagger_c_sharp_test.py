...
namespace Agora.Rtc
{
    ...
    public abstract class IRtcEngine
    {
      ...
      virtual public void SetForUser()
      {
      }
...
/* api_irtcengine_setforuser */      
      virtual public void SetForUser(uint uid = 0, string channelId = "", VIDEO_SOURCE_TYPE source_type = VIDEO_SOURCE_TYPE.VIDEO_SOURCE_CAMERA_PRIMARY)
      {
      }
